...
class SchexManagerApp {
  ...
  onEvtCtlMethod(evtInfo) {
    ...
    switch (evtInfo.method) {
      ...
      case con.Method.ctlStartJob:
      case con.Method.ctlStopJob:
        if (this.curOperaCtlCb !== null) {
          this.curOperaCtlCb(evtInfo);
        }
        break;
      default: break;
    }
  ...
  sendCtlMsg(info, cb = null) {
    ...
    if (info.method !== con.Method.ctlSta && info.name === undefined) {
      if (cb !== null) {
        cb({ status: false, msg: 'Required jobName parame!' });
      } else {
    ...
    if (this.curOperaCtlMethod !== null) {
      if (cb !== null) {
        cb({ status: false, msg: `Now is Handler job ${this.curOperaCtlMethod.jobName}` });
      } else {
